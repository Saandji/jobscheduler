 ...
 * @property recurrence Specifies the recurrence strategy for the job execution. Defaults to `Recurrence.Once`.
 * @property retryPolicy Defines the behavior for handling job retries in case of failures. Defaults to a single attempt.
...
class JobDefinition<T>(
    ...
    //NOTE: Still not 100% sure we want and need this type, but I keep it for until I test with pure java
